...
--
-- Host: 127.0.0.1
-- Czas generowania: 04 Mar 2021, 16:07
...
INSERT INTO `countries` (`country_id`, `countryName`, `twoCharCountryCode`, `threeCharCountryCode`) VALUES
...
INSERT INTO `customers` (`id`, `cityid`, `name`, `surname`, `nip`, `postalCode`, `birthday`, `height`, `create_date`) VALUES
(1, 1, 'Katarzyna', 'Nowak', '', '', '2020-10-01', '185.50', '2021-02-18 15:41:45'),
(2, 2, 'Janusz', 'Kowalski', '', '', '1980-02-15', '175.50', '2021-02-18 15:41:45'),
(3, 1, 'Paweł', 'Nowak', '', '', '2021-02-18', '185.50', '2021-02-18 16:37:07');
...
ALTER TABLE `sales_details`
  ...
  ADD KEY `transaction_no` (`transaction_no`,`product_id`),
...
--
ALTER TABLE `sales`
  MODIFY `transaction_no` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT dla tabeli `sales_details`
--
ALTER TABLE `sales_details`
  MODIFY `sales_details_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `customers`
  ADD CONSTRAINT `customers_ibfk_1` FOREIGN KEY (`cityid`) REFERENCES `cities` (`city_id`);

--
-- Ograniczenia dla tabeli `sales`
--
ALTER TABLE `sales`
  ADD CONSTRAINT `sales_ibfk_1` FOREIGN KEY (`client_id`) REFERENCES `customers` (`id`);
