...
<div class="container2">
    <p>login: <?php echo "$użytkownicy[login]"; ?></p>
   <p>Imię: <?php echo "$użytkownicy[Imie]"; ?></p>
   <p>Nazwisko: <?php echo "$użytkownicy[Nazwisko]"; ?></p>
   <p>E-mail: <?php echo "$użytkownicy[email]"; ?></p>
   <p>Data urodzenia: <?php echo "$użytkownicy[data_urodzenia]"; ?></p>
   <p>plec: <?php echo "$użytkownicy[plec]"; ?></p>
    </div>
